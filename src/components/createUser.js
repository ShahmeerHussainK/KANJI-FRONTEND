...
class CreateUser extends Component{
    ...
    handleOrganizationSelectBranch = (organization) => {
        this.setState({ organization,loadingBranches:true});
    ...
    create_user = () =>{
        ...
        if(this.state.isSuper === false && this.state.isOrg === false && this.state.isBranch === false
            && this.state.isBranchView === false
            ){
            this.setState({
                messageTitle:"User type not seletced",
                messageBody:"Please select a user type",
                messageBoxOpen:true,
                messageType:1
            })
            return
        ...
        if(this.state.isOrg === true && this.state.organization === null){
            this.setState({
                messageTitle:"Organization Missing",
                messageBody:"You have selected Organization Admin as user type. Please select organization for user",
                messageBoxOpen:true,
                messageType:2
            })
            return
        ...
        if(this.state.isBranch === true && this.state.branch === null){
            this.setState({
                messageTitle:"Branch Missing",
                messageBody:"You have selected Branch Admin as user type. Please select branch for user",
                messageBoxOpen:true,
                messageType:3
            })
            return
        ...
        if(this.state.isBranchView === true && this.state.branch === null){
            this.setState({
                messageTitle:"Branch Missing",
                messageBody:"You have selected Branch View as user type. Please select branch for user",
                messageBoxOpen:true,
                messageType:3
            })
            return
        ...
        var arg_list = '&first_name='+fname+'&last_name='+lname+"&email="+email+'&username='+username+'&password='+password

        arg_list = this.state.isSuper ? arg_list+'&is_superuser=True' : arg_list
        arg_list = this.state.isOrg ? arg_list+'&is_organisation_admin=True&org_id='+this.state.organization.id : arg_list
        arg_list = this.state.isBranch ? arg_list+'&is_branch_admin=True&branch_id='+this.state.branch.id : arg_list
        arg_list = this.state.isBranchView ? arg_list+'&is_branch_view=True&branch_id='+this.state.branch.id : arg_list
    ...
    render(){
        ...
        <Modal isOpen={this.state.branchAdminSelectionModalOpen}>
        <ModalHeader>Select Branch For User</ModalHeader>
        <ModalBody>
        <Loader loading={this.state.loadingBranches} />
            <div>
            <h3 ><b>Select Organization</b></h3>
        ...
        <ModalFooter>
            <Button color="primary" onClick={this.closeBranchSelectModal}>Done</Button>
        </ModalFooter>
        </Modal>
            ...
            <form>
                    ...
                    <div className="form-group" style={{marginTop:20}}>
                        <div className="row" >
                            ...
                            <input type="radio" name="usertype" className="form-radio" value="superuser" onChange={this.HandleSuperAdminSelect}></input><label className="my-label"><b>Super Admin</b></label>
                            </div>
                            <div className="col-md-4">
                            <input type="radio" name="usertype" value="orgAdmin" className="form-radio" onChange={this.HandleOrgAdminSelect}></input><label className="my-label"><b>Organizational Admin</b></label>
                            </div>
                            <div className="col-md-4">
                            <input type="radio" name="usertype" value="branchAdmin" className="form-radio" onChange={this.HandleBranchAdminSelect}></input><label className="my-label"><b>Branch Admin</b></label>
                            </div>
                            <div className="col-md-4">
                            <input type="radio" name="usertype" value="isBranchView" className="form-radio" onChange={this.HandleBranchViewSelect}></input><label className="my-label"><b>Branch User</b></label>
                            </div>
                        </div>
                    </div>
