                    ...
                    <tbody>
                        <tr hidden={!this.props.data.true_action_log}>
                            ...
                            <td hidden={!this.props.data.true_action_log}>
                                    <b className="question_view_bold">Type:</b><span style={{marginLeft:5}}>{this.props.data.true_action_log_type_name}</span><br/>
                                    <b className="question_view_bold">Text:</b><span style={{marginLeft:5}}>{this.props.data.true_action_log_text}</span><br/>
                    ...
                    <tbody>
                        <tr hidden={!this.props.data.false_action_log}>
                            ...
                            <td hidden={!this.props.data.false_action_log}>
                                    <b className="question_view_bold">Type:</b><span style={{marginLeft:5}}>{this.props.data.false_action_log_type_name}</span><br/>
                                    <b className="question_view_bold">Text:</b><span style={{marginLeft:5}}>{this.props.data.false_action_log_text}</span><br/>
                                    <b className="question_view_bold">Log Options:</b>
                                    <ul>
