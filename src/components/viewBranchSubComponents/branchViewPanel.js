                        ...
                        <div class="col-md-4" id={"branchPanel" + this.props.data.branch_id}>
                            ...
                            <Modal isOpen={this.state.viewModalOpen}>
                                ...
                                <ModalBody>
                                    ...
                                    <div className="row" style={{ marginTop: 10 }}>
                                        <div className="col-md-6">
                                            <h5>Branch Photo Upload Directory:</h5><b>{this.state.data.branch_photo_upload_directory}</b>
                                        </div>
                                        <div className="col-md-6">
            ...
            return (
                ...
                <Modal isOpen={this.state.viewModalOpen}>
                                ...
                                <ModalBody>
                                    ...
                                    <div className="row" style={{ marginTop: 10 }}>
                                        <div className="col-md-6">
                                            <h5>Branch Upload Directory is:</h5><b>{this.state.data.branch_photo_upload_directory}</b>
                                        </div>
                                        <div className="col-md-6">
                                            {/* <h4>Branch Photo Upload Password:</h4><b>{this.props.data.branch_photo_upload_password}</b> */}
                                        </div>
