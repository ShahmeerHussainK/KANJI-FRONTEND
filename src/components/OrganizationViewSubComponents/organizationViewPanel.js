        ...
        return(
           ...
           <div class="panel-layout">
               ...
               <div class="panel-box col-xs-4 bg-green">
                   ...
                   <img id={"logo"+this.props.data.organisation_id} src={media_url+this.props.data.organisation_logo} height={110} width={110} alt="" class="org_logo" ></img>
                   </div>
               </div>
        ...
        return(
           ...
           <div class="panel-layout">
               ...
               <div class="panel-box col-xs-8">
                   ...
                   <div class="panel-content  bg-black">
                       <div class="sparkline-big">
                       <a href={"/list-branches/?id="+this.props.data.organisation_id+"&tag="+this.props.data.organisation_name} className="org_title_0" >
                       <h3 className="organizationName" id={"name"+this.props.data.organisation_id}>{this.props.data.organisation_name}</h3>
                       </a>
                       {/* <h6 className="organizationName">Daft Dimbo</h6> */}
                       </div>
