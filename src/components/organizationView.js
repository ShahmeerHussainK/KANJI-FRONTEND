...
class OrganizationList extends Component{ 
   ...
   componentWillMount = () =>{
    ...
    //(url+'/api/organisation?user_id='+user_id)
    http.open('GET', url+'/api/organisation?user_id='+user_id+'&page='+this.state.currentPage, true);
            ...
            if(http.readyState === 4 && http.status === 200) {
                ...
                if(json.status === 200){
                    ...
                    json.organisations.forEach(element =>{
                        dashboar_ref.setState(prevState => ({
                            org_list: [...prevState.org_list, element]
                          }))
                    })
                }
   ...
   update_organization = (event) =>{
    ...
    //("@@@@")
    //(this.state.editTarget.organisation_id)
                    ...
                    <Modal isOpen={this.state.editModalOpen}>
                        ...
                        <form id="orgData">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="thumbnail">
                                        <img id='logoThumbnail' src={media_url+this.state.editTarget.organisation_logo} alt=""></img>
                    ...
                    <Modal isOpen={this.state.editModalOpen}>
                        ...
                        <form id="orgData">
                                    ...
                                    <div class="form-group ">
                                        {/* <input type="file" id="logofile"></input> */}
                                        <div class="thumbnail">
                                        <img id='logoThumbnail' src={media_url+this.state.editTarget.org_logo} alt=""></img>
                                        <h3 onClick={this.OpenFileBrowser}>Update</h3>
                                        <input type="file" id="logo" hidden={true} onChange={this.changePreviewImg}/>
                                    </div>
                                    <p class="isa_error" hidden={this.state.FileErrorHidden}><i class="fa fa-times-circle"></i>{this.state.message_body}</p>
