  ...
  <Router>
    <Provider store={store}>
      <div>
        ...
        <Route
          path="/device-registeration-requests/"
          component={DeviceRegisterationRequests}
        />
        <Route path="/view-all-devices/" component={ViewAllDevices} />
        <Route path="/list-devices/" component={ListBranchDevices} />
        <Route
          path="/list-revoked-devices/"
          component={ListBranchRevokedDevices}
        />
        <Route
          path="/list-revoked-organizations/"
          component={RevokedOrganizationList}
        />
        <Route
          path="/list-revoked-branches/"
          component={RevokedOrganizationViewPanel}
        />
