...
class RoleManagement extends Component{
    ...
    componentWillMount = () =>{
        ...
        if(cookies.get('branch-admin') === "true"){
        ...
        this.state.allUsers.forEach(element =>{
            if(user.id === element.user_id){
                ...
                if(element.is_revoked === true){
                    ...
                    this.setState({branchEdit:true,orgEdit:true,orgEdit:true})
                }
            }
            this.setState({
                selectedUser:user,
    ...
    fetchOrgBranches = (org_id) =>{
        console.log("fetch received "+org_id)
        var cookies = new Cookies();
        var user_id = cookies.get('user_id')
        var token = cookies.get('token')
    ...
    updateRoles = () =>{
        ...
        if(this.state.superuser === "true"){
            var superUser = document.getElementById("super").checked
        }     
