...
class CreateOrganization extends Component {
    ...
    componentWillMount = () => {
        ...
        if (branch_admin === 'true' | organization_admin === 'true') {
    ...
    create_organization = (event) =>{
        ...
        http.onreadystatechange = function (){
            ...
            global_ref.setState({
                loading:false,
                message_title:"Error",
                message_body:"Server Could not be contacted",
                message_type:2,
                message_box_open:true
            })
        }
                        ...
                        <div className="row" style={{marginTop:30}}>
                            ...
                            <div className="col-md-8">
                                <form id="orgData">
                                    ...
                                    <div class="form-group ">
                                        <div class="thumbnail">
                                        <img id='logoThumbnail' src="https://via.placeholder.com/200x200.png?text=Preview"></img>
