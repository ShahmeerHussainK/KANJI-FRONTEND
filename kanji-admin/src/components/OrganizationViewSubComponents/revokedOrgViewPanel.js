...
class RevokedOrganizationViewPanel extends Component{
    ...
    HandleActivateClick = () =>{
        ...
        console.log( url+'/api/organisation/revoked?user_id='+user_id+'&org_id='+this.props.data.organisation_id)
    ...
    render(){
        console.log(media_url+this.props.data.organisation_logo)
        return(
           ...
           <div class="panel-layout">
               <div class="panel-box col-xs-4 bg-green">
                   ...
                   <img id={"logo"+this.props.data.org_id} src={media_url+this.props.data.organisation_logo} alt="" class="org_logo" ></img>
                   </div>
               </div>
