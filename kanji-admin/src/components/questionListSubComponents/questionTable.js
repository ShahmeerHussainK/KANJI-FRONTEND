...
class QuestionTable extends Component{
    ...
    handlePageChange(pageNumber) {
      ...
      handleViewClick = (id) =>{
        ...
        console.log("element "+this.state.selected_question_for_view)
      }
      ...
      handleEditClick = (id) =>{
        ...
        console.log("element "+this.state.selected_question_for_edit)
      }


      handleDeleteClick = (id) =>{
          console.log("asking to delete "+id)
          this.setState({
        ...
        if(this.state.section === 1){
            if(this.props.data === undefined || this.props.data.length == 0){
                ...
                return(
                   ...
                   <tbody>
                   {this.props.data.map((question,i)=><TableRow key={i} data={question} serialNo={i} viewClickHandle={this.handleViewClick} editClickHandle={this.handleEditClick} handleDeleteClick={this.handleDeleteClick} close_delete_modal={this.close_delete_modal}/>) }
                   {/* <TableRow />
                   <TableRow />
                   <TableRow /> */}
                   </tbody>
