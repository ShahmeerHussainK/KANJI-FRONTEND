        ...
        if(this.props.data){
            return(
                ...
                <td >
                    ...
                    <button class="btn btn-xs font-back " style={{backgroundColor:'#4CAF50', color:'white',marginRight:5}} id={this.props.data.question_id} onClick={this.handle_edit_click} disabled={!this.props.data.is_editable}>Edit</button>

                    <button class="btn btn-xs font-back " style={{backgroundColor:'#F44336', color:'white',marginRight:5}} id={this.props.data.question_id} onClick={this.handle_delete_click} disabled={!this.props.data.is_editable}>Delete</button>
                </td>
                </tr>
