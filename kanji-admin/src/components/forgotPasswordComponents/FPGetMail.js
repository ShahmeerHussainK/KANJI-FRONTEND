...
class FPGetMail extends Component{
    ...
    render(){
       return(
        <form action="" id="login-validation" className="col-md-4 center-margin" onKeyPress={this.handleEnterPress.bind(this)}>
            ...
            <div className="content-box-wrapper pad20A">
                ...
                <div className="form-group">
                    ...
                    <i className="fa fa-envelope inputicon"></i>
                        <input type="email" className="form-control" id="inputEmail" placeholder="Enter email" onChange={this.validateEmail} onKeyPress={this.handleEnterPress.bind(this)}></input>
